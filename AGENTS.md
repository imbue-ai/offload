...
- **Bead IDs**: When creating beads, you MUST supply a randomly generated 6-character UUID as the bead ID (e.g. `bd create --id "$(openssl rand -hex 3)" ...`). Do NOT use autogenerated sequential numbers.
